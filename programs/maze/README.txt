...
In windows 95 (and a few later versions of Windows) there was a screensaver that rendered and then solved a 3D maze. This project is a recreation of that screensaver using WebGL and Javascript. It was created in Spring 2019. The matrix libraries used are from https://github.com/esangel/WebGL/tree/master/Common and under the MIT License.

A YouTube sample of the original screensaver can be found at https://www.youtube.com/watch?v=7-yMd9Kt4mQ
